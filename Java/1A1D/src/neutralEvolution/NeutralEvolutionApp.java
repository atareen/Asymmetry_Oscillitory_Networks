...
public class NeutralEvolutionApp{
	...
	public static int evolutionTimeTotal = 12000;
	...
	public static void main(String[] args)
	{
		...
		int[] in1Logo = new int[NE.M];
		int[] in2Logo = new int[NE.M];
		int[] out1Logo = new int[NE.M];
		int[] out2Logo = new int[NE.M];
		...
		//while(1>0)
		{
			...
			else if(pvrTest[0]-pvrTest[1]<0.5 & pvrTest[2]-pvrTest[3]< 0.5)
			{
				// relative PVR
					...
					for(int i=0;i<NE.M;i++) {System.out.print(in1[i]+",");}//System.out.println();
					for(int i=0;i<NE.M;i++) {System.out.print(out1[i]+",");}//System.out.println();
					for(int i=0;i<NE.M;i++) {System.out.print(in2[i]+",");}//System.out.println();
					for(int i=0;i<NE.M;i++) {System.out.print(out2[i]+",");}//System.out.println();
					System.out.println();
		...
		for(int i=0;i<NE.M;i++) {System.out.print(in1Logo[i]/(1.0*acceptedMutations)+", ");}System.out.println();
		for(int i=0;i<NE.M;i++) {System.out.print(in2Logo[i]/(1.0*acceptedMutations)+", ");}System.out.println();
		for(int i=0;i<NE.M;i++) {System.out.print(out1Logo[i]/(1.0*acceptedMutations)+", ");}System.out.println();
		for(int i=0;i<NE.M;i++) {System.out.print(out2Logo[i]/(1.0*acceptedMutations)+", ");}System.out.println();
